...
NAME = "aadjoininfo"
DESCRIPTION = "Display Microsoft Entra ID join information."
...
def build_plan(args) -> dict[str, object]:
    return zero_arg_build_plan(NAME, UPSTREAM_DIR / "entry.c", include_dirs=[COMMON_INCLUDE_DIR, UPSTREAM_DIR])
