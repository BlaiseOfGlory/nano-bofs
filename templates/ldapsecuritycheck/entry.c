...
void go(char* args, int len) {
	...
	static const wchar_t NANO_FINAL_DC[] = L"__NANO_FINAL_DC__";
	static const wchar_t NANO_FINAL_SPN[] = L"__NANO_FINAL_SPN__";

	const wchar_t* finalDC = NANO_FINAL_DC;
	const wchar_t* finalSPN = NANO_FINAL_SPN;

	BeaconPrintf(CALLBACK_OUTPUT, "[+] Target DC: %S\n", finalDC);
	BeaconPrintf(CALLBACK_OUTPUT, "[+] Target SPN: %S\n", finalSPN);

	BeaconPrintf(CALLBACK_OUTPUT, "\n[*] Testing LDAP signing requirements...\n");
	checkLDAP((wchar_t*)finalDC, (wchar_t*)finalSPN, FALSE);

	BeaconPrintf(CALLBACK_OUTPUT, "\n[*] Testing LDAPS channel binding requirements...\n");
	checkLDAP((wchar_t*)finalDC, (wchar_t*)finalSPN, TRUE);
}
