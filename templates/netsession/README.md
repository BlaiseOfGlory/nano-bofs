# netsession template notes

This template is based on the upstream SA `netsession` BOF and adapted for
nano-bofs.
...
- If upstream SA changes session enumeration or output behavior, review whether
  those changes should be ported here.
- If Windows session enumeration APIs or host-handling behavior change, update
