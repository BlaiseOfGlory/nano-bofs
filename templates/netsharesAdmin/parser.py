...
NAME = "netsharesAdmin"
DESCRIPTION = "List shares on the local or specified computer with admin-level detail."
VARIABLES = [
    {
        "name": "server",
        "required": False,
...
DEFAULT_TEMPLATE = Path(__file__).resolve().parents[1] / "netshares" / "entry.c"
COMMON_INCLUDE_DIR = (
